              ...
              <div className="w-full grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 lg:gap-10 mb-16 lg:mb-32">
                ...
                {allAssets.map((asset, index) => (
                  <motion.div
                    ...
                    onClick={() => setSelectedMedia({ url: asset.type === 'post' ? `/selected-work/gopal-snacks/post-0${asset.num}.png` : `/selected-work/gopal-snacks/reel-0${asset.num}.mp4`, isVideo: asset.type === 'reel' })}
