...
export function SurbhikaMarigoldModal({ isOpen, onClose }: CampaignModalProps) {
              ...
              <div className="w-full flex justify-center mb-8 lg:mb-16">
                ...
                >
                  ...
                  <div className="relative w-full h-full overflow-hidden rounded-2xl">
                    <video
                      src="/all-work/3D Product Visualization/01 SURBHIKA MARRIGOLD PETALS VIDEO WEBSITE.mp4"
                      autoPlay
                      muted
                      controls
                      playsInline
