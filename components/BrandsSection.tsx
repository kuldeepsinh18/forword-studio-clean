...
export function BrandsSection() {
  return (
    <section className="w-full bg-[#050505] text-white py-[60px] lg:py-[140px] px-5 lg:px-[4.5rem] relative overflow-hidden flex justify-center">
      ...
      <div className="w-full max-w-[1600px] mx-auto relative z-10 flex flex-col items-start">
        <motion.div
          initial="hidden"
          whileInView="visible"
